...
void loop(){
    ...
    if(client.status()==4){
        ...
        String postData = "leituraX0=" + String(gpio0) + "&leituraX1=" + String(gpio2) + "&leituraX2=" + String(gpio4) + "&leituraX3=" + String(a0);
